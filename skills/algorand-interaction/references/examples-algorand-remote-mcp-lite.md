# Algorand Remote MCP Lite - Workflow Examples
...
### Step 2: Check asset verification (optional)
```
...
> **Opt-Out**: Use asset creator address for both `to` and `closeRemainderTo` in asset transfer with amount 0.
