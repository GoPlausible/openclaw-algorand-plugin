...
- The `registerExactAvmScheme` function at `@x402/avm/exact/facilitator` is distinct from the client and server variants. Always import from the correct subpath.
