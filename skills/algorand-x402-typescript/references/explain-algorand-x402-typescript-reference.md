...
|----------|-------------|-----------|
| `registerExactAvmScheme` | `@x402/avm/exact/client` | `(client, { signer, algodConfig?, networks?, policies? })` |
| `registerExactAvmScheme` | `@x402/avm/exact/server` | `(server, { networks? }?)` |
| `registerExactAvmScheme` | `@x402/avm/exact/facilitator` | `(facilitator, { signer, networks })` |
